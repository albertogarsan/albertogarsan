    ...
    var load = function() {
        ...
        showBtn = function(selBtn) {
            if (selBtn === 0) {
                ...
                $('#part4_4').html('<span><a href="mailto:albertogarsan@outlook.com" target="_blank">Mail me</a></span> and see my <span><a href="CV-albertogarsan_compressed" target="_blank">CV!</a></span>');
